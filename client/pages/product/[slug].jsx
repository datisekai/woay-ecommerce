...
export default function Product({ itemProduct }) {
    ...
    const variant = useMemo(() => {
        return variants.find(
            (item) =>
                item.colorId === active.colorId && item.sizeId === active.sizeId
        );
    }, [active]);
                    ...
                    <div className="wrap grid grid-cols-1 lg:grid-cols-2 ">
                        ...
                        <div className="right">
                            ...
                            <button
                                ...
                                onClick={() =>
                                    setActive({
                                        colorId: 0,
                                        sizeId: 0,
                                        colors: itemProduct.variants.map(
                                            (item) => item.colorId
                                        ),
                                        sizes: itemProduct.variants.map(
                                            (item) => item.sizeId
                                        ),
                                    })
                                }
                            ...
                            <div className="flex  mt-[10px] my-[25px] items-center">
                                ...
                                <span className="ml-2">
                                    {variant?.quantity || 0} sản phẩm có sẵn
                                </span>
                            </div>
